...
WebUI.callTestCase(findTestCase('Auth/Login with problem_user'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Page_Swag Labs/input_First Name'), 'John')

WebUI.setText(findTestObject('Page_Swag Labs/input_Last Name'), 'Doe')
